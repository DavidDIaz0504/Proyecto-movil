        ...
        btnIniciarSesion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (email.isEmpty() || password.isEmpty()) {
                    Toast.makeText(login_activity.this, "Debe rellenar todos los campos", Toast.LENGTH_SHORT).show();
                } else {
                    // Mostrar Toast de éxito
                    Toast.makeText(login_activity.this, "Cuenta creada satisfactoriamente", Toast.LENGTH_SHORT).show();
