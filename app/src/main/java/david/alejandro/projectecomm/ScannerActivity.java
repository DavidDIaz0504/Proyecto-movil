...
public class ScannerActivity extends AppCompatActivity {
    ...
    public void classifyImage (Bitmap image){
        try {
            ...
            image.getPixels (intValues,0, image.getWidth(),0, 0, image.getWidth(), image.getHeight()); int pixel = 0;
            ...
            String[] classes = { "Case","Dialga", "Diario Hello Kitty","Forro Hello Kitty","Goku","Paleta de sombras","Pocillo mascotas","Powerbank","Wireless","Comestiquera"};
