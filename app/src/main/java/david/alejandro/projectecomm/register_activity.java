        ...
        btnCrearCuenta.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.isEmpty() || email.isEmpty() || password.isEmpty()) {
                    Toast.makeText(register_activity.this, "Debe rellenar todos los campos", Toast.LENGTH_SHORT).show();
                } else {
                    // Mostrar Toast de éxito
                    Toast.makeText(register_activity.this, "Cuenta creada satisfactoriamente", Toast.LENGTH_SHORT).show();

                    // Si no hay campos vacíos, procede con el registro
                    Intent intent = new Intent(register_activity.this, rol_activity.class);
